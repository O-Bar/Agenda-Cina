            ...
            <div class="col-12 col-md-10 text-center mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h1>Seja bem vindx ao AgendaCina</h1>
                    </div>
                    <div class="card-body">
                        <img class="card-img-top" style="width: 150px;" src="../images/date-icon.jpg" alt="...">
                        <p class="card-text">
                            Precisa tomar vacina? Não pegue mais filas, agende já a sua vacina na UBS mais próxima de você.
                        </p>
                        <a href="../visao/agendamento.php" class="agend-form-btn mx-auto">Agende aqui</a>
                    </div>
